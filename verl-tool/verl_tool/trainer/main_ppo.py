...
def run_ppo(config) -> None:
    ...
    if not ray.is_initialized():
        ...
        ray.init(
            runtime_env={"env_vars": {"TOKENIZERS_PARALLELISM": "true", "NCCL_DEBUG": "WARN", "VLLM_LOGGING_LEVEL": "WARN", "VLLM_ALLOW_RUNTIME_LORA_UPDATING": "true", "VLLM_USE_V1": os.getenv("VLLM_USE_V1", "1"), "ROCR_VISIBLE_DEVICES": os.getenv("ROCR_VISIBLE_DEVICES", ""), "HIP_VISIBLE_DEVICES": os.getenv("HIP_VISIBLE_DEVICES", ""), "CUDA_VISIBLE_DEVICES": os.getenv("CUDA_VISIBLE_DEVICES", "")}},
