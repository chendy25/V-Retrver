...
dataset_name=V_Retrver_eval_data
...
gpu_memory_utilization=0.88 # higher gpu_memory_utilization will likely cause the vllm to OOM and get stuck, so set it to a lower value like 0.4 or 0.5
...
run_name_postfix="eval_mbeir_cirr_task7_test"
...
PYTHONUNBUFFERED=1 python3 -m verl_tool.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.val_kwargs.top_p=$top_p_val \
